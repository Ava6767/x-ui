...
```sh
bash <(curl -Ls https://raw.githubusercontent.com/Ava6767/x-ui/master/install.sh)
```
...
```sh
VERSION=1.8.0 && bash <(curl -Ls "https://raw.githubusercontent.com/Ava6767/x-ui/$VERSION/install.sh") $VERSION
```
